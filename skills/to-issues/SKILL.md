...
3. **Size to the sharp zone.** An issue should be buildable well within ~100k tokens of working context. Bigger → split; the builder will further slice internally, but the issue boundary should already be small.
